                        ...
                        <form action="{{ route('cases.update', $case->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" name="country" id="country" value="{{ $case->country }}" class="form-control">
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="division">Division</label>
                                    <input type="text" name="division" id="division" value="{{ $case->division }}" class="form-control">
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="district">District</label>
                                    <input type="text" name="district" id="district" value="{{ $case->district }}" class="form-control">
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="thana">Police Station</label>
                                    <input type="text" name="thana" id="thana" value="{{ $case->thana }}" class="form-control">
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="category" id="category" class="form-control" required>
                                        ...
                                        <option value="civil" {{ old('category', $case->category ?? '') == 'civil' ? 'selected' : '' }}>Civil</option>
                                        <option value="criminal" {{ old('category', $case->category ?? '') == 'criminal' ? 'selected' : '' }}>Criminal</option>
                                    </select>
                                </div>
                                            ...
                                            <select name="client_id" class="form-control select2">
                                                @foreach ($clients as $client)
                                                    <option value="{{ $client->id }}"
                                                        {{ (old('client_id', $case->client_id ?? null) == $client->id) ? 'selected' : '' }}>
                                                        {{ $client->user->name }}
                                                    </option>
                                                @endforeach
                                            </select>
